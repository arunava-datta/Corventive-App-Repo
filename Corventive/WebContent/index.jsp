    ...
    <body id="body" data-spy="scroll" data-target=".header">
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      ...
			      <ul class="nav navbar-nav">
			        <li class="js_nav-item nav-item"><a href="#body">Home</a></li>
			        <li class="js_nav-item nav-item"><a href="#about">About</a></li>
			        <li class="js_nav-item nav-item"><a href="#products">Products</a></li>
			        <li class="js_nav-item nav-item"><a href="#pricing">Pricing</a></li>
			        <li class="js_nav-item nav-item"><a href="#work">Work</a></li>
			        <li class="js_nav-item nav-item"><a href="#service">Service</a></li>
			        <li class="js_nav-item nav-item"><a href="#contact">Contact</a></li>
			      </ul>
			      
			      <ul class="nav navbar-nav navbar-right">
			        <li class="js_nav-item nav-item"><a class="cd-signin" href="#">Sign In / Sign Up</a></li>
			        <li class="dropdown" style="display: none;">
			    	  <span>
			          <a href="#" style="padding-top: -15px;" class="dropdown-toggle" data-toggle="dropdown">
			          	<img alt="" src="img/signin_icon.png" style="width: 40px; margin: 10px; margin-top: 5px;"/>
						...
						<ul id="login-dp" class="dropdown-menu">
							<li>
								 <div class="row">
								 		...
								 		<div id="welcome-user" class="bottom text-center"></div>
								 		<div class="bottom text-center"><a class="cd-logout" href="#">Sign Out</a></div>
		...
		<div class="cd-user-modal-container"> <!-- this is the container wrapper -->
			...
			<div id="cd-login"> <!-- log in form -->
				<form class="cd-form" id="loginForm" action="login" method="post">
					<p class="fieldset">
						<label class="image-replace cd-email" for="signin-email">E-mail</label>
						<input class="full-width has-padding has-border" name="username" id="signin-email" type="email" placeholder="E-mail">
			...
			<div id="cd-signup"> <!-- sign up form -->
				<form class="cd-form" id="signUpForm" action="signup" method="post">
					<p class="fieldset">
						<label class="image-replace cd-email" for="signup-email">First Name</label>
						<input class="full-width has-padding has-border" name="fname" id="signup-email" type="text" placeholder="First Name">
						<span class="cd-error-message">Error message here!</span>
					</p>
					
					<p class="fieldset">
						<label class="image-replace cd-email" for="signup-email">Last Name</label>
						<input class="full-width has-padding has-border" name="lname" id="signup-email" type="text" placeholder="Last Name">
						<span class="cd-error-message">Error message here!</span>
					</p>
					
					<p class="fieldset">
						<label class="image-replace cd-email" for="signup-email">E-mail</label>
						<input class="full-width has-padding has-border" name="username" id="signup-email" type="email" placeholder="E-mail">
						<span class="cd-error-message">Error message here!</span>
					</p>
